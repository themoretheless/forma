...
test('linked inheritance renders all branches through the actual Rust/WASM core', {skip:!existsSync(new URL('../public/vector-pkg/forma.js',import.meta.url))},async()=>{
